...
const ToolHelp = props => {
  return (
    <div>
      <p><pre>Place:</pre> The place tool can be used to place objects in the level. When selected, the current highlighted object will be placed in the level when a tile is clicked.</p>
